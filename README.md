...
هدف این مجموعه، دیده‌شدن، حمایت و همکاری در پروژه‌هاست و انتظار می‌رود تأثیری مثبت بر فعالیت‌های اعضا در دنیای اوپن سورس داشته باشد.
...
| Text2Excel | یک برنامه گرافیکی با Python Tkinter برای جمع آوری داده ها از فایل متنی و قرار دادن در فایل Excel یا CSV با الگو های RegEx | [لینک کخزن](https://github.com/AmirAli1019/Text2Excel) |
...
برای افزودن پروژهٔ جدید و مشارکت در این مخزن، لطفاً راهنمای مشارکت را مطالعه کنید:
